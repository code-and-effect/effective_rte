/*
* StylishRte Rich Text Editor was based on:
...
(function($) {
    ...
    StylishRTE.fn = StylishRTE.prototype = {
        ...
        insertAsset: function(text) {
            console.log(text);
            console.log($.fn);
            console.log(StylishRTE.fn);
            // StylishRTE.pasteHTML(text);
            // this.pasteHTML(text);
            //if ($.browser.msie) {
            //    this.ec("createLink", true, text);
            //} else {
            //    this.ec("createLink", false, text);
            //}
        },
